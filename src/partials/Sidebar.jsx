            ...
            <ul className="mt-3">
              ...
              <SidebarLinkGroup activecondition={pathname.includes('/books')}>
                {() => {
                  return (
                    <React.Fragment>
                      <a href="/books" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('/books') && 'hover:text-slate-200'}`}
                      >
                        ...
                        <div className="flex items-center justify-between">
                          <div className="flex items-center">
                            <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
                              <path
                                className={`fill-current text-slate-400 ${pathname.includes('/books') && 'text-indigo-300'}`}
                                d="M13 15l11-7L11.504.136a1 1 0 00-1.019.007L0 7l13 8z"
                              />
                              <path
                                className={`fill-current text-slate-700 ${pathname.includes('/books') && '!text-indigo-600'}`}
                                d="M13 15L0 7v9c0 .355.189.685.496.864L13 24v-9z"
                              />
                              <path
                                className={`fill-current text-slate-600 ${pathname.includes('/books') && 'text-indigo-500'}`}
              ...
              <SidebarLinkGroup activecondition={pathname.includes('/orders')}>
                {() => {
                  return (
                    <React.Fragment>
                      <a href="/orders" className={`block text-slate-200 hover:text-white truncate transition duration-150 ${pathname.includes('/orders') && 'hover:text-slate-200'}`}
                      >
